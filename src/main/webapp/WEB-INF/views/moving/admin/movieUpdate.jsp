   ...
   <div class="as_movie-list">
	   ...
	   <form action="movieUpdate.admin?mv_cd=${dto.mv_cd}" method="post" id="movieUpdate" >
	      <fieldset>
	         ...
	         <table class="table as_movie-detail-table">
	            <colgroup>
	               <col class="col8">
	               <col class="col16">
	               <col class="col8">
	            ...
	            <tbody>
	            	...
	            	<tr>
	            		<td colspan="10" class="as_plot">
	            			<textarea class="form-control" name="mv_plot">${dto.mv_plot}</textarea>
	            		</td>
	            	</tr>
	            	<tr>
	            		<th scope="row">포스터</th>
		      ...
		      <div class="as_movie-add-footer">
		         <div class="btns">
		            <button type="button" class="btn btn-danger">수정 취소</button>
